...
enemy1 = Sprite(-s_width, 0, 5, 'square', 'red')
enemy1.set_move(-s_width, 0, s_width, 0)
enemy2 = Sprite(s_width, 70, 5, 'square', 'red')
...
if total_score == 3:
   ...
   enemy2.hideturtle()
    ...
    # print total_score
    FONT = ('SegoeUI', 72, 'normal')
    score_t = Turtle()
    score_t.penup()
    score_t.clear()
    score_t.goto(0,150)
    score_t.write(f'YOUR SCORE: {total_score}', FONT)
    score_t.hideturtle()
    score_t.getscreen()._root.mainloop()
